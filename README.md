...
- `arbor` (`bin/arbor`): Manage git branches/worktrees with merged cleanup, branch-to-worktree and worktree-to-main conversion, direct deletion, and force-with-lease pushing; detailed usage in [`docs/arbor/usage.md`](docs/arbor/usage.md).
