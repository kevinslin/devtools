...
- 🌱 `seed`: [sshx](docs/sshx/usage.md) <img src="assets/sshx-inline.png" alt="SSH sync terminal mascot" width="24" height="24" style="vertical-align: text-bottom;" />; entry point `bin/sshx`; sync configured dotfiles and Codex config with rsync or tar fallback, install a safe `.zshrc.local` overlay without replacing remote `.zshrc`, then open ssh
