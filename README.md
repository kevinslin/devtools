...
- 🌱 `seed`: [gitsync](docs/gitsync/usage.md); entry point `bin/gitsync`; safely synchronize cron-scheduled Git repositories with optional post-sync hooks using launchd
